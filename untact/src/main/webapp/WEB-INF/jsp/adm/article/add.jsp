...
<script>
fileInputMaxCount = parsInt("${fileInputMaxCount}");
</script>
...
function ArticleAdd__checkAndSubmit(form){
	...
	startUploadFiles(startSubmitForm); //startUploadFiles 실행 후에 startSubmitForm 실행됨
}
</script>
		...
		<form onsubmit="ArticleAdd__checkAndSubmit(this); return false;" action="doAdd" method="POST" enctype="multipart/form-data">
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input type="text" name="title" autofocus="autofocus" 
						class="form-row-input w-full rounded-sm" placeholder="제목을 입력해 주세요."/>
				</div>
			</div>
			<div class="form-row flex flex-col lg:flex-row">
				<div class="lg:flex lg:items-center lg:w-28">
			...
			<c:forEach begin="1" end="${fileInputMaxCount}" var="inputNo">
				<div class="form-row flex flex-col lg:flex-row">
					...
					<div class="lg:flex-grow">
						<input type="file" name="file__article__0__common__attachement__${inputNo}" 
